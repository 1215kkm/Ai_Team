...
1. **증거 적층 생태계** (Receipt Stacking + Owned Ecosystem) — 한 활동에서 *N중 자산* (현금/이력/플랫폼/타인활동) 동시 추출. CEO 가 KAIAT·카페24·인프런·Crowny Class 에서 직감으로 운영하던 패턴. 상세: [`patterns/owned-ecosystem-receipt-stacking.md`](.claude/knowledge/team-memory/patterns/owned-ecosystem-receipt-stacking.md)
